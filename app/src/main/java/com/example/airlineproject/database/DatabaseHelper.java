package com.example.airlineproject.database;
...
import com.example.airlineproject.HelperUtils.HelperUtilities;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void updateDatabase(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        if (oldVersion < 1) {
            ...
            //toronto to ottawa
            insertFlight(db, "Toronto", "Ottawa", "2020-8-27", "2020-8-27", "10:10", "12:10", 200.00, 1);
            insertFlight(db, "Toronto", "Ottawa", "2020-8-27", "2020-8-27", "10:10", "12:10", 150.00, 2);
            insertFlight(db, "Toronto", "Ottawa", "2020-8-27", "2020-8-27", "11:10", "12:10", 350.00, 3);
            insertFlight(db, "Toronto", "Ottawa", "2020-8-27", "2020-8-27", "09:10", "12:10", 250.00, 4);
            insertFlight(db, "Toronto", "Ottawa", "2020-8-27", "2020-8-27", "10:10", "12:10", 100.00, 5);

            //ottawa to toronto
            insertFlight(db, "Ottawa", "Toronto", "2020-9-13", "2020-9-13", "10:10", "12:10", 120.00, 6);
            insertFlight(db, "Ottawa", "Toronto", "2020-9-13", "2020-9-13", "09:00", "12:10", 150.00, 7);
            insertFlight(db, "Ottawa", "Toronto", "2020-9-13", "2020-9-13", "10:10", "12:10", 170.00, 8);
            insertFlight(db, "Ottawa", "Toronto", "2020-9-13", "2020-9-13", "09:00", "12:10", 140.00, 9);
            insertFlight(db, "Ottawa", "Toronto", "2020-9-13", "2020-9-13", "09:00", "12:10", 100.00, 10);
            insertFlight(db, "Ottawa", "Toronto", "2020-9-13", "2020-9-13", "10:10", "12:10", 350.00, 11);

            //Edmonton to winnipeg
            insertFlight(db, "Edmonton", "Winnipeg", "2020-9-20", "2020-9-20", "02:00", "04:45", 300.00, 2);
            insertFlight(db, "Edmonton", "Winnipeg", "2020-9-20", "2020-9-20", "01:00", "03:15", 205.00, 1);
            insertFlight(db, "Edmonton", "Winnipeg", "2020-9-20", "2020-9-20", "09:00", "12:20", 350.00, 10);
            insertFlight(db, "Edmonton", "Winnipeg", "2020-9-20", "2020-9-20", "08:00", "10:15", 400.00, 11);
            insertFlight(db, "Edmonton", "Winnipeg", "2020-9-20", "2020-9-20", "11:00", "13:11", 250.00, 1);

            //winnipeg to edmonton
            insertFlight(db, "Winnipeg", "Edmonton", "2020-9-25", "2020-9-25", "11:00", "13:11", 300.00, 9);
            insertFlight(db, "Winnipeg", "Edmonton", "2020-9-25", "2020-9-25", "09:00", "12:00", 250.00, 1);
            insertFlight(db, "Winnipeg", "Edmonton", "2020-9-25", "2020-9-25", "08:00", "11:00", 400.00, 3);
            insertFlight(db, "Winnipeg", "Edmonton", "2020-9-25", "2020-9-25", "01:00", "04:00", 150.00, 7);
            insertFlight(db, "Winnipeg", "Edmonton", "2020-9-25", "2020-9-25", "12:00", "14:00", 350.00, 10);


            insertFlight(db, "Montreal", "Edmonton", "2020-9-30", "2020-9-30", "10:10", "12:10", 350.00, 4);
            insertFlight(db, "New York", "Edmonton", "2020-10-01", "2020-10-01", "09:10", "12:10", 185.00, 5);
            insertFlight(db, "Quebec City", "NewYork", "2020-10-02", "2020-10-02", "11:10", "12:10", 250.00, 6);
            insertFlight(db, "Charlottetown", "Victoria", "2020-10-03", "2020-10-03", "10:10", "12:10", 360.00, 7);
            insertFlight(db, "Los Angeles", "Ottawa", "2020-10-04", "2020-10-04", "10:10", "12:10", 350.00, 8);
            insertFlight(db, "Winnipeg", "Toronto", "2020-10-05", "2020-10-05", "09:10", "12:10", 350.00, 9);
            insertFlight(db, "Victoria", "New York", "2020-10-06", "2020-10-06", "10:10", "12:10", 350.00, 10);
